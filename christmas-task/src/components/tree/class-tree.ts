...
class Tree{
    treeArea:string;
    mainTreeContainer:HTMLElement | null;
    constructor(treeArea:string, mainTreeContainer:HTMLElement | null){
...
export let tree = new Tree(area, document.getElementById('tree-tree'));
